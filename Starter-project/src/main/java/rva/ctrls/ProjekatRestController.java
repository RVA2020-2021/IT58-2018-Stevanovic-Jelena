...
public class ProjekatRestController {
	...
	@ApiOperation(value = "Vraća projekat iz baze podataka čiji je id vrednost prosleđena kao path varijabla")
	...
	@ApiOperation(value = "Briše projekat iz baze podataka čiji je id vrednost prosleđena kao path varijabla")
